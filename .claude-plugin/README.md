...
v0.5.7 has been tested against 107 real Claude Code sessions / 53,668 events / 665 git operations / 376 problem-fix episodes across 37 inferred projects. 103 unit tests passing. Security-audited with zero critical findings.
